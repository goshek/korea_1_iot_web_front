...
const apikey = "6166b0fd096193b1b2ad7791eccdcbe8";
const lang = "kr";

const api = `http://api.openweathermap.org/data/2.5/weather?q=${city}&appid=${apikey}&lang=${lang}&units=metric`;
//https://api.openweathermap.org/data/2.5/weather?q=${city}&lang=${lang}&units=metric&appid={API key}
...
time.textContent= day+','+ (times.getMonth()+1)+','+ times.getDate()+','+ times.getFullYear();
