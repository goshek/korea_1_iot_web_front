...
const fetchBtn= document.getElementById('fetchUserData') as HTMLButtonElement;
...
document.addEventListener('DOMContentLoaded',async ()=>{
    ...
    try{
        console.log('loading...');
        const fetchedData= await fetchPosts(userId);
    }
    catch(e){
        console.error('처리 실패');
    }
    ...
    const userIdElement= document.getElementById('fetchUserData');
