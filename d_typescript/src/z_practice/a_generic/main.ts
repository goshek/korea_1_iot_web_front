  ...
  class TaskManager<T> {
    ...
    renderTasks(containerId: string): void {
      ...
      this.tasks.forEach(task => {
        ...
        // <li>content의 값 <button>삭제</button></li> 
        ...
        // <li>content의 값 <button>삭제</button><input type='checkbox' checked /></li> 
    ...
    updateTaskCount() {
      ...
      // countElement.textContent = `할 일 개수: ${this.tasks.length}` - Error
