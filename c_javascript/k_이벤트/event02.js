...
//이벤트 객체를 전달받아 이벤트가 발생된 요소의 배경을 변경
// >>event(이벤트 객체).target
function bgChange(event){
    const randomColor= `rgb(${random(255)},${random(255)},${random(255)})`;
    //return randomColor;

    //event.target: HTML요소(JS Dom요소- 객체)
...
/*
    ...
    >> 매개변수의 명을 event, evt, e등으로 명명을 권장
*/
...
/*
    이벤트 객체 실습
    16개의 타일 세트
    querySelectorAll()을 사용 >> 16개의 참조를 tiles상수에 할당
...
//         event.target.backgroundColor=tileChange();
//     }
// })
